                ...
                <Row>
                  ...
                  <Col>
                    <Row style={{textAlign: 'center', }}>
                      <Col style={{textAlign: 'right'}}><p4>DPadUp = Forward</p4></Col>
                      <Col style={{textAlign: 'left'}}><p4>A = Increase Linear Speed</p4></Col>
                    </Row>
                    <Row style={{textAlign: 'center'}}>
                      <Col style={{textAlign: 'right'}}><p4>DpadDown = Backward</p4></Col>
                      <Col style={{textAlign: 'left'}}><p4>B = Decrease Linear Speed</p4></Col>
                    </Row>
                    <Row style={{textAlign: 'center'}}>
                      <Col style={{textAlign: 'right'}}><p4>DPadLeft = Turn Left</p4></Col>
                      <Col style={{textAlign: 'left'}}><p4>X = Increase Angular Speed</p4></Col>
                    </Row>
                    <Row style={{textAlign: 'center'}}>
                      <Col style={{textAlign: 'right' }}><p4>DPadRight = Turn Right</p4></Col>
                      <Col style={{textAlign: 'left'}}><p4>Y = Decrease Angular Speed</p4></Col>
                    </Row>
                  </Col>
                </Row>
                <GamepadSvg
